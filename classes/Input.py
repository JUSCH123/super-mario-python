...
class Input:
    ...
    def checkForKeyboardInput(self):
        ...
        if pressedKeys[K_LEFT] or pressedKeys[K_a] or pressedKeys[K_h] and not pressedKeys[K_RIGHT]:
            self.entity.traits["goTrait"].direction = -1
        elif pressedKeys[K_RIGHT] or pressedKeys[K_d] or pressedKeys[K_l] and not pressedKeys[K_LEFT]:
            self.entity.traits["goTrait"].direction = 1
        else:
        ...
        isJumping = pressedKeys[K_SPACE] or pressedKeys[K_w] or pressedKeys[K_UP] or pressedKeys[K_k]
